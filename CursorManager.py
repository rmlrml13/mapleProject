...
class CursorManager:
    ...
    def __init__(self, game):
        ...
        self.animation_frame_number = [normal_frame_number, selectable_frame_number, selectable_frame_number,
                                       selectable_frame_number]
        self.animation_speed = [normal_frame_speed, selectable_frame_speed, selectable_frame_speed,
                                selectable_frame_speed]
