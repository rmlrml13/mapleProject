...
class Effect:
    ...
    def __init__(self, game, x, y, effect_blueprint:EffectBluePrint):
        ...
        # 오프셋 적용
        self.sprite = self.canvas.create_image(x + self.effect_blueprint.sprite_offset[0], y + self.effect_blueprint.sprite_offset[1],\
    ...
    def update(self):
        ...
        # 그외의 경우는 animation_speed로 애니메이션 재생
            ...
            self.canvas.itemconfig(self.sprite, image = self.effect_blueprint.animation_sprites[self.current_frame_number])
